    ...
    return {
        getData: function() {
            ...
            let response = {
                ...
                sss_deduction: contriSSS.part.employee.toFixed(2),
                phlhealth_deduction: contriPhilhealth.part.employee.toFixed(2),
                pagibig_deduction: contriPagibig.part.employee
            }
